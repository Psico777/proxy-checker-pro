...
import { IcClock, IcCheck2, IcShield, IcArchive } from './Icons.jsx';
    ...
    <div className="guide">
      ...
      <section className="panel guide-hero">
        ...
        <div className="why-grid">
          <div className="why-card"><span className="wc-ic"><IcClock size={22} /></span><b>Ahorra horas</b><p>~20.000 proxies verificadas automáticamente en paralelo.</p></div>
          <div className="why-card"><span className="wc-ic"><IcCheck2 size={22} /></span><b>Solo las que sirven</b><p>Doble verificación elimina las muertas y los falsos positivos.</p></div>
          <div className="why-card"><span className="wc-ic"><IcShield size={22} /></span><b>Anonimato real</b><p>Detecta si el proxy filtra tu IP (transparente / anónimo / elite).</p></div>
          <div className="why-card"><span className="wc-ic"><IcArchive size={22} /></span><b>Tu baúl</b><p>Guarda las mejores y reúsalas cuando quieras, exporta a TXT/CSV/JSON.</p></div>
        </div>
      </section>
...
request.meta["proxy"] = "http://IP:PUERTO"`}</pre>
      ...
      <section className="panel guide-warn">
        <h3 className="guide-h">Uso responsable</h3>
